...
if __name__ == "__main__":
    ...
    qc_runs = os.listdir(os. getcwd())
    # qc_runs = [
    #     "new_0_cube_h2_nofvqe_pes.dat",
    #     "new_1_cube_h2_nofvqe_pes.dat",
    #     "new_2_cube_h2_nofvqe_pes.dat",
    # ]

    plot_pes_sim_qc_stats(
        nofvqe_data,
        qc_runs,
        save_prefix="lam_9_pes_H8_scan_hybrid_mean_std",
    )
