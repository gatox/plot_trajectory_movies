...
class PlotsH2:
    ...
    def __init__(self):
        ...
        self.markers = list(Line2D.filled_markers)[:6]
        self.titles = ["Noisless","Noise/Conv_Tol: 1.0e-2","Noise/Conv_Tol: 1.0e-3"]
    ...
    def plot_pos_vel_3db(self,output_1,output_2,output_3):
        ...
        ax.plot(crd_2, vel_3 / 1e-3, color=self.colors[2], linestyle='--', label = self.titles[2])
        ...
        ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.15), prop={'size': 12}, ncol=3,frameon=False)
    ...
    def plot_time_total_energy_3db(self, output_1,output_2,output_3):
        ...
        plt.xlim([0, 10])
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.15), prop={'size': 12}, ncol=3,frameon=False)
    ...
    def plot_time_parmameter_3db(self, output_1,output_2,output_3):
        db_1, time_1 = self.read_db(output_1)
        db_2, time_2 = self.read_db(output_2)
        db_3, time_3 = self.read_db(output_3)
...
if __name__=="__main__":
    ...
    #picture.plot_pos_vel_3db(db_1,db_2,db_3)
    # picture.plot_time_total_energy_3db(db_1,db_2,db_3)
    picture.plot_time_parmameter_3db(db_1,db_2,db_3)
